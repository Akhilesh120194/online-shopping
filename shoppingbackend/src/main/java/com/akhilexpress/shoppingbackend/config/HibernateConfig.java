package com.akhilexpress.shoppingbackend.config;
...
@Configuration
@ComponentScan(basePackages={"com.akhilexpress.shoppingbackend.dto"})
...
//	jdbc:mysql://127.0.0.1:3306/
	...
	private final static String DATABASE_PASSWORD="akhilesh";
	...
	public SessionFactory getSessionFactory(DataSource dataSource) {
		...
		builder.scanPackages("com.akhilexpress.shoppingbackend.dto");
